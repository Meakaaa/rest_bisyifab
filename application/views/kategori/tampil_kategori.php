...
<meta charset="UTF-8">
    ...
    <link rel="icon" href="application/assets/kategorio.png">
...
<body>
  <div class="flex justify-center mt-2 mx-5">
                <div>    
                    <h1 class="mr-[350px] text-4xl font-semibold">Data kategori</h1>
                </div>

                <div class="text-1xl space-x-5 text-white font-semibold">
                    <a href="<?php echo site_url('kategori/simpan')?>">
            ...
            <center>
                <table id="myTable" class="table table-striped" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class=""><?php echo $l->id_kategori ?></td>
                            <td class=""><?php echo $l->nama_kategori ?></td>
                            <td class="">
                                <a href="<?php echo site_url('kategori/ubah/' . $l->id_kategori) ?>">Ubah</a>
                                |
                                <a href="<?php echo site_url('kategori/hapus/' . $l->id_kategori) ?>">Hapus</a>
                            </td>
                        </tr> 
                        <?php endforeach; ?>
                    </tbody>
