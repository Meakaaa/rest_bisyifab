...
<meta charset="UTF-8">
    ...
    <link rel="icon" href="application/assets/newso.png">
...
<body>
  <div class="flex justify-center mt-2 mx-5">
                <div>    
                    <h1 class="mr-[350px] text-4xl font-semibold">Data news</h1>
                </div>

                <div class="text-1xl space-x-5 text-white font-semibold">
                    <a href="<?php echo site_url('news/simpan')?>">
                ...
                <table id="myTable" class="table table-striped" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="">
                                <a href="<?php echo site_url('news/ubah/' . $l->id_news) ?>">Ubah</a>
                                |
                                <a href="<?php echo site_url('news/hapus/' . $l->id_news) ?>">Hapus</a>
                            </td>
                        </tr> 
                        <?php endforeach; ?>
                    </tbody>
