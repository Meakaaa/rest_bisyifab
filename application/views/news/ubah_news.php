        ...
        <form action="" method="post">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <input type="text" name="id_news" class="form-control" value="<?php echo $news->id_news ?>" hidden>
                    <input type="text" name="id_kategori" class="form-control" value="<?php echo $news->id_kategori ?>">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="content" class="form-control" value="<?php echo $news->content ?>">
                </div>
                <div class="mb-3">
