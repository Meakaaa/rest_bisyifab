...
<body>
    <div class="card mx-10 my-10">
        <div class="card-header bg-red-500 text-white">
            <h1>Tambah Data News</h1>
        </div>

        <form action="<?= base_url('news/simpan'); ?>" method="POST">
        
        <div class="card-body">
        
        <div class="mb-3">
            <label for="" class="form-label">ID Kategori</label>
            <textarea class="form-control" name="id_kategori" id="exampleFormControlTextarea1" rows="3"></textarea>
        </div>
        ...
        <div class="mb-3">
            <label for="" \ class="form-label">Content</label></label>
