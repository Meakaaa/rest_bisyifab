    ...
    <div class="min-h-screen sm:flex sm:flex-row mx-0 justify-center">
      <div class="flex justify-center self-center  z-10">
        <div class="p-12 bg-white mx-auto rounded-2xl w-100 ">
          ...
          <form action="<?= site_url('user/login') ?>" method="POST">
            <div class="space-y-5">
              <div class="space-y-2">
                ...
                <input class=" w-full text-base px-4 py-2 border  border-gray-300 rounded-lg focus:outline-none focus:border-orange-400" type="" placeholder="Enter your username" name="username">
              </div>
              <div class="space-y-2">
                <label class="mb-5 text-sm font-medium text-gray-700 tracking-wide">
                  Password
                </label>
                <input class="w-full content-center text-base px-4 py-2 border  border-gray-300 rounded-lg focus:outline-none focus:border-orange-400" type="password" placeholder="Enter your password" name="password">
              </div>
              <?= $this->session->flashdata('user _gagal'); ?>
              <div>
          ...
          <div>
            <p class="text-sm text-center text-gray-500 tracking-wide">Dont have any account? <a href="<?php echo base_url('user/daftar') ?>">Register</a>.</p>
          </div>
        </div>
      </div>
    </div>
