...
<body>
    <div class="card mx-10 my-10">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" name="kode_resep" id="exampleFormControlTextarea1" rows="3"></textarea>
        </div>
        
        <div class="mb-3">
            <label for="" class="form-label">kode_rekapmedis</label>
            <textarea class="form-control" name="kode_rekapmedis" id="exampleFormControlTextarea1" rows="3"></textarea>
        </div>

        <div class="mb-3">
            <label for="" class="form-label">kode_obat</label>
            <input type="text" name="kode_obat" class="form-control" id="exampleFormControlInput1" placeholder="">
        </div>

        <div class="mb-3">
            <label for="" \ class="form-label">jumlah</label></label>
            <textarea class="form-control" name="jumlah" id="exampleFormControlTextarea1" rows="3"></textarea>
        </div>

        <div class="mb-3">
            <label for="" \ class="form-label">keterangan</label></label>
