...
<meta charset="UTF-8">
    ...
    <link rel="icon" href="application/assets/usero.png">
...
<body>
  <div class="flex justify-center mt-2 mx-5">
                <div>    
                    <h1 class="mr-[350px] text-4xl font-semibold">Data user</h1>
                </div>

                <div class="text-1xl space-x-5 text-white font-semibold">
                    <a href="<?php echo site_url('user/simpan')?>">
                ...
                <table id="myTable" class="table table-striped" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class=""><?php echo $l->username ?></td>
                            <td class=""><?php echo $l->password ?></td>
                            <td class="">
                                <a href="<?php echo site_url('user/ubah/' . $l->id_user) ?>">Ubah</a>
                                |
                                <a href="<?php echo site_url('user/hapus/' . $l->id_user) ?>">Hapus</a>
                            </td>
                        </tr> 
                        <?php endforeach; ?>
                    </tbody>
