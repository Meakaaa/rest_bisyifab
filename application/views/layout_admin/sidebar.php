<aside class="main-sidebar sidebar-light-primary elevation-4">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-linecap="round"
						stroke-linejoin="round" stroke-width="2" class="brand-image"
						viewBox="0 0 24 24">
						<path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"></path>
					</svg>
				<span class="brand-text font-weight-light">BiSyifa</span>
			</a>
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					<div class="image">
						<img src="<?php echo base_url();?>assets/adminlte3/dist/img/user2-160x160.jpg"
					...
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
						...
						<li class="nav-item">
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item">
									<a href="<?= base_url('comment') ?>" class="nav-link">
										<i class="far fa-circle nav-icon"></i>
										<p>Data Comment</p>
									</a>
								</li>
								...
								<li class="nav-item">
									<a href="<?= base_url('rekapmedis') ?>" class="nav-link">
										<i class="far fa-circle nav-icon"></i>
