...
<meta charset="UTF-8">
    ...
    <link rel="icon" href="application/assets/doktero.png">
...
<body>
  <div class="flex justify-center mt-2 mx-5">
                <div>    
                    <h1 class="mr-[350px] text-4xl font-semibold">Data dokter</h1>
                </div>

                <div class="text-1xl space-x-5 text-white font-semibold">
                    <a href="<?php echo site_url('dokter/simpan')?>">
                ...
                <table id="myTable" class="table table-striped" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th class="">nama_dokter</th>
                            <th class="">alamat</th>
                            <th class="">no_telepon</th>
                            <th class="">Aksi</th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class=""><?php echo $l->nama_dokter ?></td>
                            <td class=""><?php echo $l->alamat ?></td>
                            <td class=""><?php echo $l->no_telepon ?></td>
                            <td class="">
                                <a href="<?php echo site_url('dokter/ubah/' . $l->id_dokter) ?>">Ubah</a>
                                |
                                <a href="<?php echo site_url('dokter/hapus/' . $l->id_dokter) ?>">Hapus</a>
                            </td>
                        </tr> 
                        <?php endforeach; ?>
                    </tbody>
